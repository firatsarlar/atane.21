...
export class Logo extends Component<LogoProps, any> {
    ...
    render() {
        const rect = (this.props.innerOnly) ? null
            : <g>
                <rect id="bg" class="cls-1" x="2" y="2" width="213.33" height="148.67"/>
                <polygon class="cls-2" points="67.75 37.84 101.6 36.87 101.6 39.37 67.75 40.34 67.75 37.84"/>
                <polygon class="cls-2" points="60.07 44.14 108.71 41.37 108.71 43.87 60.07 46.63 60.07 44.14"/>
                <polygon class="cls-2" points="47.3 50.2 128.9 45.14 128.9 47.64 47.3 52.7 47.3 50.2"/>
                <polygon class="cls-2" points="24.4 57.36 152.71 59.59 152.71 62.09 24.4 59.85 24.4 57.36"/>
                <polygon class="cls-2" points="71.19 53.59 154.79 52.21 154.79 54.71 71.19 56.09 71.19 53.59"/>
                <polygon class="cls-2" points="46.73 64.06 137.28 64.75 137.28 67.24 46.73 66.55 46.73 64.06"/>
                <polygon class="cls-2" points="72.96 69.35 132.98 69.67 132.98 72.16 72.96 71.85 72.96 69.35"/>
                <g id="Ellipse_1" data-name="Ellipse 1">
                    <path class="cls-3" d="M108.71,40.33A2.29,2.29,0,1,0,111,42.62,2.29,2.29,0,0,0,108.71,40.33Z"/>
                </g>
                <g id="Ellipse_1_copy" data-name="Ellipse 1 copy">
                    <circle class="cls-2" cx="60.07" cy="45.28" r="2.28"/>
                </g>
                <g id="Ellipse_1-2" data-name="Ellipse 1">
                    <path class="cls-3" d="M102.32,35.8a2.29,2.29,0,1,0,2.29,2.29A2.29,2.29,0,0,0,102.32,35.8Z"/>
                </g>
                <g id="Ellipse_1_copy-2" data-name="Ellipse 1 copy">
                    <circle class="cls-2" cx="68.06" cy="39.16" r="2.28"/>
                </g>
                <g id="Ellipse_1_copy_2" data-name="Ellipse 1 copy 2">
                    <path class="cls-3" d="M47.57,49.2a2.29,2.29,0,1,0,2.29,2.29A2.29,2.29,0,0,0,47.57,49.2Z"/>
                </g>
                <g id="Ellipse_1_copy_3" data-name="Ellipse 1 copy 3">
                    <path class="cls-4" d="M128.9,44.1a2.29,2.29,0,1,0,2.28,2.29A2.29,2.29,0,0,0,128.9,44.1Z"/>
                </g>
                <g id="Ellipse_1_copy_6" data-name="Ellipse 1 copy 6">
                    <path class="cls-3" d="M71.68,52.45A2.29,2.29,0,1,0,73.9,54.8,2.3,2.3,0,0,0,71.68,52.45Z"/>
                </g>
                <g id="Ellipse_1_copy_7" data-name="Ellipse 1 copy 7">
                    <path class="cls-3" d="M154.85,51.17a2.29,2.29,0,1,0,2.23,2.35A2.29,2.29,0,0,0,154.85,51.17Z"/>
                </g>
                <g id="Ellipse_1_copy_7-2" data-name="Ellipse 1 copy 7">
                    <circle class="cls-2" cx="152.71" cy="60.84" r="2.28"/>
                </g>
                <g id="Ellipse_1_copy_8" data-name="Ellipse 1 copy 8">
                    <path class="cls-3" d="M24.26,56.27a2.29,2.29,0,1,0,2.29,2.29A2.29,2.29,0,0,0,24.26,56.27Z"/>
                </g>
                <g id="Ellipse_1_copy_17" data-name="Ellipse 1 copy 17">
                    <path class="cls-4" d="M133,68.66a2.29,2.29,0,1,0,2.29,2.28A2.28,2.28,0,0,0,133,68.66Z"/>
                </g>
                <g id="Ellipse_1_copy_10" data-name="Ellipse 1 copy 10">
                    <path class="cls-3" d="M46.73,63A2.29,2.29,0,1,0,49,65.31,2.29,2.29,0,0,0,46.73,63Z"/>
                </g>
                <g id="Ellipse_1_copy_19" data-name="Ellipse 1 copy 19">
                    <path class="cls-4" d="M137.29,63.71A2.29,2.29,0,1,0,139.57,66,2.28,2.28,0,0,0,137.29,63.71Z"/>
                </g>
                <g id="Ellipse_1_copy_20" data-name="Ellipse 1 copy 20">
                    <path class="cls-3" d="M73,68.2a2.29,2.29,0,1,0,2.29,2.29A2.28,2.28,0,0,0,73,68.2Z"/>
                </g>
            </g>
        return (
            <svg xmlns="http://www.w3.org/2000/svg"  id={this.props.id || "logox"} style={this.props.style} viewBox={this.props.viewBox || "0 0 217.33 152.67"}>

    <defs>
        <style>
            {`
            .cls-1{fill:#313539;stroke:#e6e6e6;stroke-miterlimit:10;stroke-width:4px;}
            .cls-2,.cls-3{fill:#e6e6e6;}
            .cls-3,.cls-4{fill-rule:evenodd;}
            .cls-4,.cls-6{fill:#fff;}
            .cls-5{fill:#d2d2d2;}`}
            </style>
    </defs>
    <title>logox</title>
